...
public class ContactClient {
	...
	public static void main(String[] args) {
		...
		WebResource r = c.resource("http://localhost:8080/MyJersey/rest/contacts");
		...
		Contact cnt = new Contact("ggg", "Guo Qing", Arrays.asList(addrs));
	...
	public static void getOneContact(WebResource r, String id) {
		...
		JAXBElement<Contact> jaxbContact = r.path(id).accept(MediaType.APPLICATION_JSON).get(generic);
		System.out.println("jaxbContact!!!!"+jaxbContact);
		System.out.println("jaxbContact!!!!"+jaxbContact.getValue());
